![docker image](https://github.com/mado89/diss-nomad-oasis/actions/workflows/docker-publish.yml/badge.svg)


# mado89's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of mado89.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/mado89/diss-nomad-oasis.git
    cd diss-nomad-oasis
    ```
    ...
    ```sh
    curl-L -o diss-nomad-oasis.zip "https://github.com/mado89/diss-nomad-oasis/archive/main.zip"
    unzip diss-nomad-oasis.zip
    cd diss-nomad-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/mado89/diss-nomad-oasis:main` for the services
...
```
docker pull ghcr.io/mado89/diss-nomad-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/mado89/diss-nomad-oasis/manifests/main": unauthorized`
